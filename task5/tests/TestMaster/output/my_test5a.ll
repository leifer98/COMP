@.str0 = constant [8 x i8] c"OR true\00"@.str1 = constant [9 x i8] c"OR false\00"
...
define void @main() {
%t1 = add i1 0, 1
br i1 %t1, label %label_4, label %label_3
label_3:
%t2 = add i1 0, 0
...
br label %label_1
label_2:
%t4 = getelementptr inbounds [9 x i8], [9 x i8]* @.str1, i32 0, i32 0
